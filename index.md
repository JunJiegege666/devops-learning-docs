...
hero:
  name: "DevOps 学习笔记"
  text: "从 Linux 到 K8s 的实战之路"
  tagline: "实战指南 / 常用命令 / 避坑手册"
  actions:
    - theme: brand
      text: 开始学习 (Linux)
      link: /phase1
    - theme: alt
      text: GitHub 仓库
      link: https://github.com/JunJiegege666/devops-learning-docs

features:
  - title: 第一阶段：Linux 基础
    details: 用户管理、权限控制、Systemd 服务配置、Nginx 反向代理与 Shell 脚本自动化监控。
  - title: 第二阶段：Docker 容器化
